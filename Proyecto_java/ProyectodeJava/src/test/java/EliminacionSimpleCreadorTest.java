...
public class EliminacionSimpleCreadorTest {

    private final EliminacionSimpleCreador creador = new EliminacionSimpleCreador();
    ...
    public void testCrearTorneo_CasoNormal() throws TorneoException {
        var torneo = (TorneoAbstracto) creador.crearTorneo("Torneo Test", "FUTBOL", 4);
        assertNotNull(torneo);
        assertInstanceOf(TorneoAbstracto.class, torneo);
        assertEquals("Torneo Test", torneo.obtenerNombre());
    }

    @Test
    public void testCrearTorneo_CasoLimiteMinParticipantes() throws TorneoException {
        var torneo = (TorneoAbstracto) creador.crearTorneo("Torneo Test", "FUTBOL", 2);
        assertNotNull(torneo);
        assertInstanceOf(TorneoAbstracto.class, torneo);
        assertEquals("Torneo Test", torneo.obtenerNombre());
    }
